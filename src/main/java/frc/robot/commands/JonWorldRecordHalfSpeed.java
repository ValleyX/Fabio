 ...
 * 
 */
public class JonWorldRecordHalfSpeed extends CommandBase {
    ...
    public JonWorldRecordHalfSpeed(String fileName , DriveTrain driveTrain, ShooterDrive shooterDrive, IntakeFront intakeFront, IntakeBack intakeBack, Conveyor conveyor,
    ...
    public void initialize() {
     //   SmartDashboard.putNumber("JonVelInput", 2000);
       ...
       // m_driveTrain.SetPercentOutput(1, 30);
        m_driveTrain.SetPercentOutput(0.5, 30);
      /*  
...
/*
	...
	SmartDashboard.putNumber("joy count", m_joyCount);
        ...
        if ((m_joyCount % 2) == 0)
        {
            m_joy[m_joyCount/2] = new JoyStorage(
            leftYstick,
            rightYstick,
            buttonlb,
            buttonrb,
