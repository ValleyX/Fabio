...
public class IntakeFromFront extends CommandBase {
    ...
    BeanBreakBack beanBreakBack, BeanBreakFront beanBreakFront, boolean secondShot) {
    ...
    public boolean isFinished() {
        ...
        if(beanBreakMid == false && m_secondShot == false )
        {
            return true;
        }

        else if (beanBreakMid == false && beanBreakFront == false && m_secondShot ==  true)
        {
            return true;
        }
