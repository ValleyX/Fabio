 ...
 *
 */
public class FrontIntakeArmsExtend extends CommandBase {
    ...
    public FrontIntakeArmsExtend(FrontIntakeArmSub subsystem) {
    ...
    public void initialize() {
        ...
        System.out.println("in front arm intake init");
    }
