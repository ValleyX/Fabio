 ...
 *
 */
public class SequentialCommandGroup1ball extends SequentialCommandGroup {
    ...
    public SequentialCommandGroup1ball(DriveTrain driveTrain, FrontIntakeArmSub frontarm, 
