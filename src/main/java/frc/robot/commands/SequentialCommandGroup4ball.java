 ...
 *
 */
public class SequentialCommandGroup4ball extends SequentialCommandGroup {

    final double InitialShotSpeed = 7500; //7500
    final double SecondShotSpeed = 8500;  //10000
    ...
    public SequentialCommandGroup4ball(DriveTrain driveTrain, FrontIntakeArmSub frontarm, 
  ...
  */   
      ...
      //new DriveDistance(driveTrain, 0.8, 15)
       ...
       //new DriveDistance(driveTrain, 0.8, 15)
        ...
        new HeadingDrive(driveTrain, 1, 6, thirdBallHeading)
