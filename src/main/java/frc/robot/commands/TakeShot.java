...
public class TakeShot extends CommandBase {
    ...
    public TakeShot(ShooterDrive subsystem, Conveyor conveyor ) {
    ...
    SmartDashboard.putNumber("Velocity RPM", 8000);
    }
    ...
    public void execute() {
        ...
        if (m_shooterDrive.getRightTalon().getSelectedSensorVelocity(0) >= (m_velocityRPM-20) )
        {
