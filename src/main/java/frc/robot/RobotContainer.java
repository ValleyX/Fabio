...
public class RobotContainer {
  ...
  private final SequentialCommandGroupPlayBack m_SeqCmdGrp2ball;
  private final SequentialCommandGroupPlayBack m_SeqCmdGrp3ball;
  private final SequentialCommandGroupPlayBack m_SeqCmdGrp4ball;
  private final SequentialCommandGroupPlayBack m_JonCommandPlayback;
 // private final JonCommandPlayback m_JonCommandPlay4;
...
private final XboxController xboxController1 = new XboxController(0);
 ...
 /*                                             
    ...
    m_SeqCmdGrp4ball = new SequentialCommandGroup4ball(m_driveTrain,
                                              ...
                                              m_beanBreakFront);
*/
    m_JonCommandPlayback = new SequentialCommandGroupPlayBack("testRecord",
                                              m_driveTrain,
                                              m_frontIntakeArmSub, 
                                              m_shooterDrive, 
                                              m_sorter,
                                              ...
                                              m_driveBaseBlinkin1,
                                              m_driveBaseBlinkin2);
 m_SeqCmdGrp2ball = new SequentialCommandGroupPlayBack("twoball",
                                              m_driveTrain,
                                              m_frontIntakeArmSub, 
                                              m_shooterDrive, 
                                              m_sorter,
                                              ...
                                              m_driveBaseBlinkin1,
                                              m_driveBaseBlinkin2);
m_SeqCmdGrp3ball = new SequentialCommandGroupPlayBack("threeball",
                                              m_driveTrain,
                                              m_frontIntakeArmSub, 
                                              m_shooterDrive, 
                                              m_sorter,
                                              ...
                                              m_driveBaseBlinkin1,
                                              m_driveBaseBlinkin2);
 m_SeqCmdGrp4ball = new SequentialCommandGroupPlayBack("fourball",
                                              m_driveTrain,
                                              m_frontIntakeArmSub, 
                                              m_shooterDrive, 
                                              m_sorter,
...
//public JonCommandRecored(String fileName ,DriveTrain driveTrain, ShooterDrive shooterDrive, IntakeFront intakeFront, IntakeBack intakeBack, Conveyor conveyor,//
...
/*
    SmartDashboard.putData("Record4",new JonCommandRecored("4ballRecored",
    m_driveTrain,
    m_shooterDrive, 
    m_intakeFront,
    m_intakeBack,
    ...
    m_driveBaseBlinkin1,
    m_driveBaseBlinkin2));
    SmartDashboard.putData("play4",new JonCommandPlayback("4ballPlay",
      m_driveTrain,
      m_shooterDrive, 
      m_intakeFront,
      m_intakeBack,
    ...
    SmartDashboard.putData("LimeLightTester",new LimeLightTest());
  ...
  */
    ...
    m_driveTrain.setDefaultCommand(new JonWorldRecord("testRecord", m_driveTrain, m_shooterDrive, m_intakeFront, m_intakeBack, 
                                m_conveyor, m_feederSystemFront, m_feederSystemBack, m_sorter, m_frontIntakeArmSub, m_backIntakeArm,
                                m_beanBreakMid, m_beanBreakBack, m_beanBreakFront, m_deathClimbers, m_driveBaseBlinkin1, m_driveBaseBlinkin2));
    
    /*
    m_driveTrain.setDefaultCommand(new JonWorldRecordHalfSpeed("testRecord", m_driveTrain, m_shooterDrive, m_intakeFront, m_intakeBack, 
    m_conveyor, m_feederSystemFront, m_feederSystemBack, m_sorter, m_frontIntakeArmSub, m_backIntakeArm,
    m_beanBreakMid, m_beanBreakBack, m_beanBreakFront, m_deathClimbers, m_driveBaseBlinkin1, m_driveBaseBlinkin2));
*/
    ...
    // Configure autonomous sendable chooser
        ...
        m_chooser.addOption("Play Ball", m_JonCommandPlayback);
       // m_chooser.addOption("Play4Ball", m_JonCommandPlay4);
