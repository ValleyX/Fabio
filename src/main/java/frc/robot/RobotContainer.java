...
public class RobotContainer {
  ...
  private final SequentialCommandGroup1 m_SeqCmdGrp1;
...
private final XboxController xboxController1 = new XboxController(0);
  ...
  */
  private RobotContainer() {
    ...
    m_SeqCmdGrp1 = new SequentialCommandGroup1(m_driveTrain,
                                              m_frontIntakeArmSub, 
                                              m_shooterDrive, 
                                              m_sorter,
                                              m_intakeFront,
    ...
    m_beanBreakBack,
    m_beanBreakFront));
    SmartDashboard.putData("TakeShot", new TakeShot( m_shooterDrive ));
  //  SmartDashboard.putData("IntakeFromFront", new IntakeFromFront( m_intakeFront ));
    ...
    //SmartDashboard.putData("IMUTest", new imuCommand(m_imu));
    ...
    m_driveTrain.setDefaultCommand(new JonCommand(m_driveTrain, m_shooterDrive, m_intakeFront, m_intakeBack, 
                                ...
                                m_beanBreakMid, m_beanBreakBack, m_beanBreakFront));
...
xboxButtonB.whileHeld(new TakeShot( m_shooterDrive ) ,true);
    SmartDashboard.putData("Xbox Button B",new TakeShot( m_shooterDrive ) );
